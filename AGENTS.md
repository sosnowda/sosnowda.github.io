...
node game/tools/test_round68.mjs     # вода/деревья (раунд 66.5) — новые раунды добавляют свои
...
8. **Стилистика кода**: ES-модули, `const`/`let`, комментарии на русском с номером раунда («// Раунд 68 (п.5): …»), никаких тестов в рантайме игры.
