...
const sw = read('sw.js');
ok(has(sw, "var CACHE_NAME = 'chronicles-ruthenia-v79'"), 'CACHE_NAME бампнут до v77 (раунд 66.27)');
ok(has(sw, "var GAME_ASSETS_CACHE = 'game-assets-v26'"), 'game-assets-v25 (PNG воротни r67, 66.25)');
