...
ok(swSrc.includes("var CACHE_NAME = 'chronicles-ruthenia-v80'"), 'SW: site-cache v80 (66.30)');
ok(swSrc.includes("var GAME_ASSETS_CACHE = 'game-assets-v27'"), 'SW: game-assets-v27 (перекодировка ассетов 66.30)');
