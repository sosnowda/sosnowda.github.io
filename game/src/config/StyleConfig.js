...
export const DIALOG_STYLES = {
    ...
    // Стиль содержимого
    // РАУНД 66.20 (п.1 приказа): ДИНАМИЧЕСКИЙ КЕГЛЬ РЕПЛИКИ. fontMax/fontMin/
    // fontHardMin — границы best-fit-подбора в createDialog: перебором от
    // fontMax вниз выбирается НАИБОЛЬШИЙ кегль, при котором панель целиком
    // влезает в 90% высоты экрана. Короткие реплики печатаются крупно, длинные
    // ужинаются БЕЗ скролла (маска/прокрутка — аварийный предохранитель после
