...
export function timeRatioInfoLine() {
    return tk(TIME_RATIO_KEY,
        ...
        '  ещё раз, но вторая попытка идёт с меньшими шансами (−15 к Внимательности).\n' +
        ...
        '  ⏳ Счётчик «до побега вора» — сколько ИГРОВЫХ ЧАСОВ осталось до его\n' +
        '  исчезновения (тик вора = 1 игровой час; ≤3 ч — красный, ≤6 ч — оранжевый).\n' +
