...
const EN = {
    ...
    // Раунд 66.27: короткие подписи нижнего ряда околицы на низких экранах
    // ('🌲 Тёмный лес' уже переведён выше по словарю)
...
const EN_KEYS = {
    ...
    // --- Раунд 66.13: счётчик «свежести» следов вора и наводки ---
    'совсем свежий': 'very fresh',
    'ещё свежий': 'still fresh',
    'заветривается': 'fading',
    'почти истёрся': 'nearly erased',
    'совсем свежая': 'very fresh',
    'ещё свежая': 'still fresh',
    'почти истекла': 'nearly spent',
    'Свежесть следа: {0} ({1}%).': 'Track freshness: {0} ({1}%).',
    '🧭 Наводка: {0} ({1}%)': '🧭 Hint: {0} ({1}%)',
