...
export default class AudioManager {
     ...
     * Раунд 24: + музыка таверны и церкви. 66.30: фоновый прелоадер меню
     * удалён — тяжёлые треки докачиваются по требованию (playInteriorMusic
     * на входе в интерьер, EndScene на финалах) и создаются здесь.
     */
    loadMusic() {
        if (!this.scene?.sound) return;
        const musicMap = {
