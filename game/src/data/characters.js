...
export const ENEMY_TEMPLATES = {
    ...
    thief: {
        name: 'Вор-иконокрад',
        stats: { STR: 60, CON: 50, SIZ: 50, DEX: 70, INT: 60, POW: 50, CHA: 40, APP: 50 },
        weapon: { name: 'Кривой кинжал', dice: { min: 1, max: 6 }, bonus: 1 },
        // Раунд 22: явный навык атаки 50% (было ~160-170%), HP 10, кожаная броня
        attackSkill: 50,
        dodge: 30,
        db: { min: 1, max: 4 },
        spriteKey: 'enemy_bandit',
        color: 0x222222,
        armorId: 'leather',  // было chain (def 4) — бой был непроходим для слабых бойцов
    },
};
