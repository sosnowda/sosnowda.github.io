...
export const INTERIORS = {
    ...
    chapel: {
        id: 'chapel',
        name: t('Часовня Николая Чудотворца'),
        npcId: null,
        npcName: '',
        npcSprite: null,
        portrait: null,
        dialogueId: null,
        description: t('Пустой киот у алтарной стены. На полу — капли стеарина и обрывок пеньковой верёвки. После кражи иконы здесь тихо и пахнет холодным воском.'),
    ...
    church: {
        ...
        dialogueId: 'priest',
        description: t('Небольшая деревянная церковь с резным иконостасом. Пахнет ладаном и воском. У алтаря молится седой священник.'),
...
export const BUILDINGS = [
    ...
    { interiorId: 'chapel', col: 15, row: 11, w: 3, h: 3, label: t('Часовня') },
