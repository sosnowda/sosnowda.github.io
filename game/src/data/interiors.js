...
export const BUILDINGS = [
    ...
    // Южный ряд: справа (22–24 × 11–13) — НОВЫЙ жилой дом Степана
    // (раунд 63, п.1: овчарня удалена, на её месте изба).
    ...
    { interiorId: 'villager_house_3', col: 22, row: 11, w: 3, h: 3, label: t('Дом Степана') },
];
