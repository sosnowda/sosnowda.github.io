...
const NPC_ROLE = {
    ...
    shepherd_boy: 'shepherd',    // Ивашка, сын Пелагеи — при матери-ткачихе
    ...
    // Раунд 63 (п.1): овчарня удалена — в новом доме на её месте живёт
    // крестьянская семья Степана и Арины.
    peasant2: 'peasant2',        // Степан — крестьянин восточной улицы
    peasant2_wife: 'homemaker',  // Арина
...
const BASE_SCHEDULE = {
    ...
    // Раунд 63 (п.2): дом ремесленника — Аверьян живёт и работает дома
    // (лавки больше нет; торгует с крыльца, как Прасковья и Потап).
    peddler:     { dawn: 'home', morning: 'home', noon: 'home', evening: 'home', dusk: 'home', night: 'home' },
    ...
    // Раунд 63 (п.1): крестьянин Степан — двор/деревня (овчарни больше нет)
    peasant2:    { dawn: 'home', morning: 'home', noon: 'village', evening: 'home', dusk: 'home', night: 'home' },
};
...
const ACTIVITY = {
    ...
    peddler: {
        home: 'строгает ложки у верстака', village: 'носит товар по деревне',
    },
    shoemaker: {
    ...
    peasant2: {
        home: 'чинит сбрую и телегу', village: 'помогает соседям по двору',
    },
    woodcutter: {
...
export const PLACE_NAMES = {
    ...
    // Раунд 63 (п.2): лавки больше нет — Аверьян при своём доме
    shop_tools: 'в доме ремесленника',
};
...
export const OUTDOOR_LINES = {
    ...
    guard: [
        '«Прохода нет, всё проверяю. Без порядка за околицей — беда. Сторожевое дело — глаз остр.»',
    ...
    kid6: [
        ...
        '«Когда вырасту — коня себе заведу! Седло в цвет, узда с бляхами!»',
    ],
    kid7: [
    ...
    shepherd_boy: [
        '«Тс-с! Овцы дремлют. Как Рыжий заблеет — конец сну!»',
        '«Я считал овец — тридцать четыре. Или тридцать пять? Пойду пересчитаю!»',
        '«Рыжий — моя любимица. Только никому не говори!»',
    ],
    fisher_wife: [
        '«Ерёма на броду ушел. Рыба у нас есть — заходи к вечеру.»',
        '«Сети чиню да уху варю. Муж вернется — горячая будет.»',
        '«Вон, чешую высушила — на грядку бросить: земля любит!»',
    ],
    carpenter_wife: [
        '«Микула весь в стружке, а я весь день пряду. Заходи, брусничным взваром напою.»',
    ...
    apprentice: [
        ...
        '«Уголь ношу, мехи качаю — рука крепчает. Скоро и подмастерьем величаться буду.»',
    ],
    ...
    peddler: [
        '«Ножи, веревки, обереги — всякая вещь к делу пришита!»',
    ...
    shoemaker_wife: [
        ...
        '«Щи да каша — пища наша! А хочешь, сбитню с мятой?»',
    ...
    // Раунд 63 (п.1): новая семья восточной улицы
    peasant2: [
        '«Нынче рожь колосится — не боязно за зиму будет!»',
        '«Сбрую опять чинить, да руки сами просятся к топору!»',
        '«Добрый день, добрый человек! Заходи, коли мимо идёшь!»',
    ],
    peasant2_wife: [
        '«Степан до темноты возится, а у меня и щи да куры не ждут!»',
        '«Огород полола с утра — спина гудит, а душа рада!»',
        '«Рушник вышиваю к празднику. Заходи, когда топится печь!»',
    ],
};
...
export const NPC_DIALOGUE = {
    ...
    healer: 'healer1',
    kid8: 'kid8', kid9: 'kid9',
    // Раунд 63 (п.1): дом Степана да Арины (на месте бывшей овчарни)
    peasant2: 'peasant2',
    peasant2_wife: 'peasant2_wife',
