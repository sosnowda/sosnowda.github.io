...
// Рига перенесена на север (к полям), овчарня — загон на втором улице
// (частокол рисуется отдельной веткой drawYardProps вместе с овцами).
export const YARD_PROPS = [
    { id: 'riga',     col: 3,  row: 7,  w: 2, h: 1 },  // рига-сеновал на северо-западе (не под дверью старосты!)
    { id: 'haystack', col: 4,  row: 8,  w: 1, h: 1 },  // стог подле риги
    ...
    // Раунд 37: овин сохранён (сушка снопов — рига теперь на севере рядом)
