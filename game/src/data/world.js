...
export function buildMap() {
    ...
    // LocationScene — кнопка «🎣 Рыбалка»); на месте пруда — открытое
    // место в юго-западном углу, зарезервированное под новые дворы
    // (см. docs/VILLAGE_EXPANSION_PROPOSAL.md).
    ...
    // (дерево [22,3] убрано — на его месте вывеска Амбара; [7,15] — был под
    // прудом; Раунд 36: пара новых деревьев на месте бывшего пруда,
    // большая часть юго-запада оставлена пустой под будущие дворы)
    const trees = [
...
export const YARD_PROPS = [
    ...
    // §3.1 (раунд 20): баня — у двора Авдея (вода из колодца и от реки);
