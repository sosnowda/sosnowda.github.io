...
export function buildMap() {
    ...
    const TREES = [
        ...
        // 66.25 (п.2): [18,1] и [22,2] сняты — колонки заняты домами после
        // ротации планировки; у пустого северо-восточного угла посажено
        // НОВОЕ дерево [24,1] (крона у ворот, ствол вне коридора 23–25×3–7).
        [4, 1], [10, 1], [14, 1], [24, 1],
        // Средний ряд: промежутки и передние дворы.
        // 66.25: [22,6] → [22,7] — крона больше не накрывает дверь знахарки
        // (её дом теперь в северном ряду, дверь (22,3))
        [5, 6], [9, 7], [13, 6], [22, 7],
...
export const HISTORICAL_VILLAGE_NAMES = [
    ...
    'Новое Село', 'Опоки', 'Перемышль', 'Ракова слобода', 'Русса',
    'Новый Торг', 'Угличе Поле', 'Великий Холм', 'Государево Займище',
    'Чёрная Грязь', 'Малая Шуя', 'Верхняя Мельница', 'Боголюбово',
    'Березова Поляна', 'Деревянница', 'Клещин городок', 'Муромское селище',
    'Плёс на Волге', 'Славянка', 'Тихвинское село', 'Великое Село',
];
